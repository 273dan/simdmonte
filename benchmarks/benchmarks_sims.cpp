...
static void BM_10MSimsSIMDEuropean252Step(benchmark::State& state) {
  MarketData market(
      100.0, // Spot
      0.05,  // Risk free rate
      0.20   // Volatility
...
BENCHMARK(BM_10MSimsSIMDEuropean252Step)->UseRealTime();
static void BM_10MSimsSIMDConcurrentEuropean252Step(benchmark::State& state) {
  MarketData market(
      100.0, // Spot
      0.05,  // Risk free rate
      0.20   // Volatility
...
BENCHMARK(BM_10MSimsSIMDConcurrentEuropean252Step)->UseRealTime();
static void BM_100MSimsSIMDConcurrentEuropean252Step(benchmark::State& state) {
  MarketData market(
      100.0, // Spot
      0.05,  // Risk free rate
      0.20   // Volatility
...
BENCHMARK(BM_100MSimsSIMDConcurrentEuropean252Step)->UseRealTime();
