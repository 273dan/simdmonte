...
AsianAccumulator::AsianAccumulator(float strike, AsianOption::OptionType o_type,
                                   AsianOption::StrikeType strike_type,
                                   int avg_start)
    : strike_(_mm256_set1_ps(strike)), option_type_(o_type),
      strike_type_(strike_type), avg_start_(avg_start), steps_priced_(0),
      steps_elapsed_(0), sum_{_mm256_setzero_ps()} {
